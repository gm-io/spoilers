...
<div class="flex relative w-full lg:w-9/12 2xl:w-10/12 h-fit mx-auto my-5 2xl:my-8">
    <div class="absolute left-0 h-full flex items-center pl-4 pt-1">
        <div on:click={()=>goto(`/`)} on:keyup={goto('/')}  class="cursor-pointer hover:bg-stone-800 text-white transition-all duration-300 bg-black p-3 py-1 bg-opacity-90 rounded text-xs sm:text-base 2xl:text-lg">Spoilers.IO</div>
    </div>
