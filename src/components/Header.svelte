...
<div class="flex relative w-full lg:w-9/12 2xl:w-10/12 h-fit mx-auto my-6 mt-6 2xl:my-8">
    ...
    <div class="w-4/6 2xl:w-4/6 pl-2 2xl:pl-0 mx-auto relative  h-full">
        ...
        <input bind:value={query} on:keyup={SEARCH_QUERY} type="text" id="default-search" class="block rounded-2xl w-full p-4 py-2 pl-4 md:pl-10 text-sm text-gray-900 rounded-4xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-primary-200 dark:border-gray-600 dark:placeholder-gray-400 font-bold dark:text-black dark:placeholder-black" placeholder="" required>
