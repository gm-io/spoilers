...
<div class="w-full mb-4 pt-0">
    <form action="">
        <div class="w-12/12 mx-auto relative ">
            ...
            <input type="search" id="default-search" class="block w-full p-4 rounded-lg py-2 pl-10 text-sm text-gray-900 rounded-4xl bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="search ..." required>
        </div>
    </form>
</div>
